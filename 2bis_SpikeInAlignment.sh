...
bowtie2 --end-to-end --very-sensitive --no-mixed --no-discordant --phred33 -I \
10 -X 700 -p ${cores} -x ${spikeInRef} -1 $rep1 -2 $rep2 -S \
$projPath/alignment/sam/${name}_bowtie2_spikeIn.sam &> \
$projPath/alignment/sam/bowtie2_summary/${name}_bowtie2_spikeIn.txt
